                            ...
                            sshPublisherDesc(
                                ...
                                transfers: [
                                    sshTransfer(
                                        ...
                                        remoteDirectory: '/tmp',
                                        execCommand: 'unzip /home/deploy/tmp/trainSchedule.zip -d /home/deploy/tmp/train-schedule && sudo ./home/deploy/tmp/train-schedule/gradlew build && sudo ./home/deploy/tmp/train-schedule/gradlew npm_start'
                                    )
                                ]
                            )
                        ]
